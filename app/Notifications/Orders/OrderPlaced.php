...
class OrderPlaced extends BaseFlexibleNotification
{
    ...
    public function toDatabase($notifiable): array
    {
        ...
        return [
            'title' => trans('notifications.orders.placed.title'),
            'body' => trans('notifications.orders.placed.body', [
    ...
    {
        app()->setLocale($this->localeFor($notifiable));
        $text = trans('notifications.orders.placed.sms', [
            'order' => $this->data['order_number'] ?? ''
        ]);
